...
Tracking::Tracking(System *pSys, ORBVocabulary* pVoc, FrameDrawer *pFrameDrawer, MapDrawer *pMapDrawer, Atlas *pAtlas, KeyFrameDatabase* pKFDB, const string &strSettingPath, const int sensor, Settings* settings, const string &_nameSeq):
    ...
    mpYoloDetector(), framePerSecond(0), mbNewSegImgFlag(false)
{
...
void Tracking::newParameterLoader(Settings *settings) {
    ...
    int nRows = settings->nRows();
    int nCols = settings->nCols();

    mpORBextractorLeft = new ORBextractor(nFeatures,fScaleFactor,nLevels,fIniThFAST,fMinThFAST);
    // mpORBextractorLeft = new ORBextractor(nFeatures,fScaleFactor,nLevels,fIniThFAST,fMinThFAST,nRows,nCols);
...
void Tracking::SetPointCloudMapper(PointCloudMapping* pPointCloudMapping)
{
...
Sophus::SE3f Tracking::GrabImageRGBD(const cv::Mat &imRGB,const cv::Mat &imD, const double &timestamp, string filename)
{
    ...
    if (mSensor == System::RGBD)
        mCurrentFrame = Frame(this, mImGray,mImDepth,timestamp,mpORBextractorLeft,mpORBVocabulary,mK,mDistCoef,mbf,mThDepth,mpCamera);
    else if(mSensor == System::IMU_RGBD)
        mCurrentFrame = Frame(this, mImGray,mImDepth,timestamp,mpORBextractorLeft,mpORBVocabulary,mK,mDistCoef,mbf,mThDepth,mpCamera,&mLastFrame,*mpImuCalib);
    
    mCurrentFrame.yoloBoundingBoxList = yoloBoundingBoxList;
    mCurrentFrame.mvDynamicArea = mvDynamicArea;
...
void Tracking::CreateNewKeyFrame()
{
    ...
    pKF->yoloBoundingBoxList = mCurrentFrame.yoloBoundingBoxList;
